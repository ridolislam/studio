...
import { Zap, Check, ArrowLeft, Calculator, Bitcoin, ShieldCheck } from "lucide-react";
...
export default function CreditsPage() {
  ...
  const handleGoToPayment = () => {
    ...
    // Redirect to the new payment method page with query params
    router.push(`/credits/payment-method?credits=${creditAmount}&price=${totalPrice}`);
  };
